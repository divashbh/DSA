...
public class socialnet {
    ...
    static class GraphPanel extends JPanel {
        ...
        public GraphPanel() {
            ...
            loadGraphData("graphdata.txt"); // Load user data from file
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (parts.length == 2) {
                        ...
                        if (sourceNode != null && targetNode != null) {
                            ...
                            edges.add(newEdge);
                            edgePositions.put(newEdge,
                                    new Point[] { nodePositions.get(sourceNode), nodePositions.get(targetNode) });
